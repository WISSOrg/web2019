...
- WISS2019では __論文のタイトル・アブストラクトのウェブ公開を8月10日頃に、また論文本体のウェブ公開を開催1週間前の9月18日__ に予定しています。特許申請の関係などで公開を遅らせてほしい場合には申し出てください。
...
- WISS2019 では、デモ・ポスター発表の論文は「紙の予稿集への掲載はありません」（WEB掲載のみとなります）。
...
2019年07月10日頃 | 登壇発表採択結果通知（採録コメント含む）
2019年07月31日（水） | デモ・ポスター発表（論文のWEB掲載あり）投稿受付〆切（8/1 00:00 (JST) に投稿サイト閉鎖）
2019年08月01日（木） | デモ・ポスター発表（論文のWEB掲載なし）受付開始（先着順）
2019年08月10日頃 | プログラム公開（※「アブストラクト公開延期」を事前指定されたもの以外は、アブストラクトと採録コメントも公開されます）
...
WISS2019 出版担当 中村 裕美 2018pub <at> wiss.org
